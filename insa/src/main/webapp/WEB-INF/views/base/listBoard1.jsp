...
<script type="text/javascript">
	...
	function findBoardList(selectValue){
		...
		$.ajax({
	   		url:"${pageContext.request.contextPath}/base/listBoard1.do",
			...
			success : function(data){						
				...
				for (var index in data.boardlist){
					...
					html += "<td class='content'>"+"<a href=${pageContext.request.contextPath}/base/detailBoard.html?board_seq="+data.boardlist[index].board_seq+">"+str+data.boardlist[index].title+"</a>"+"</td>";				
