...
<script>
   ...
   function downloadFunc(fn,tfn){
      var path='${pageContext.request.contextPath}/base/downloadBoard.do';
      location.href=path+'?fileName='+fn+'&tempFileName='+tfn;
   }
   
   function reply(replyObj){
      var path='${pageContext.request.contextPath}/base/registForm.html';
   ...
   function findDetailBoardList(){
      ...
      $.ajax({
            url:"${pageContext.request.contextPath}/base/detailBoard.do",
   ...
   function deleteBoard(){
      $.ajax({
            url:"${pageContext.request.contextPath}/base/deleteBoard.do",
      ...
      <div class="card1">
         <div class="card-body">
            ...
            <form id="formTag">
               ...
               <a class="btn btn-outline btn-sm dark-text font-weight-bold text-dark" role="button" href="${pageContext.request.contextPath}/base/listBoard1.html">목록</a>
            </form>
         </div>
      </div>
   </div>
