...
<script>
	...
	$(document).ready(function() {
		...
		$("#modifyDept_Btn").click(function() {
			if (updatedDeptBean == null){  // 화면이 바뀌자마자 deptListAjax(); 이용하여 부서 정보를 할당했었음.
				alert("저장할 내용이 없습니다");
			} else {
	...
	// 그리드에 행 추가하는 함수
	function createNewRowData() {  // 빈 empty TO를 가지고 왔기때문에 이걸 굳이 이용? 
		var newData = {
				deptCode : "DEP00",
				deptName : "deptName",
				deptTel : "0000",
