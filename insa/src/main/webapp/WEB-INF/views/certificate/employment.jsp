...
<br>
<br>
<section id="tabs" class="wow fadeInDown" style="height:550px; width:900px;">
	
	<div class="container">
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<a class="nav-item nav-link active" data-toggle="tab" href="#employmentRequest_tab" role="tab" aria-controls="nav-home" aria-selected="true"> 재직증명서 신청</a> 
				<a class="nav-item nav-link" data-toggle="tab" href="#employmentList_tab" role="tab" aria-controls="nav-profile" aria-selected="false">재직증명서 조회</a>
			</div>
		</nav>
	</div>
	...
	<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
      ...
      <tr>
          <td>사원명</td>
          <td>
             <input type="text" class="ui-button ui-widget ui-corner-all" value="${sessionScope.name}" readonly>
      ...
      <tr>
       <td>신청일</td><td><input type="text" class="ui-button ui-widget ui-corner-all"  id="requestDate" readonly></td>
       <td>사용일</td><td><input class="ui-button ui-widget ui-corner-all" type="text" id="endDate"></td>
      
      </tr>

      <tr>
       <td>용도</td><td><input class="ui-button ui-widget ui-corner-all" id="usage" type="text">
       <input type="hidden" id="usageCode"></td>
       <td>비고</td>
       <td><input class="ui-button ui-widget ui-corner-all" type="text" id="etc"></td>
      </tr>    
       ...
       <input type="button" class="ui-button ui-widget ui-corner-all" id="issuance_employmen_Btn" value="재직증명서 신청" > 
		...
		<div class="tab-pane fade" id="employmentList_tab" role="tabpanel" aria-labelledby="nav-profile-tab">
			 <h5>신청일자</h5>
     		 ...
     		 <input type=text class="ui-button ui-widget ui-corner-all" id="email_id" placeholder="이메일을입력해주세요">
