...
<script>
	...
	$(document).ready(function() {
		...
		$("#selectOverwork").click(function() { // 이미고정되어있는데 수정 필요한듯 
	...
	/* 일수 계산 함수  */  //이미 위해서 시간을 입력안했을떄 함수 호출 안되게 해둠   // 이부분 수정 필요
	...
	function convertTimePicker(){
		...
		endTime = $("#overwork_endT").val().replace(":","");
 		...
 		if($("#overwork_endT").val().substring(0,2) < 09){ // 즉 출근시간 전일떄  즉 다음날로 이어질떄 
	...
	function registoverwork(){
		...
		var overworkList = {
		  ...
		  console.log(overworkList);
		var sendData = JSON.stringify(overworkList);  // array-like 객체를 String 문자열로 바꿔서 네트워크 통신
...
<br>
<br>
	<section id="tabs" class="wow fadeInDown" style="width:1050px;">
	<div class="container">
		<nav>
	...
	<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
		<div class="tab-pane fade show active" id="overworkAttd_tab" role="tabpanel" aria-labelledby="nav-home-tab">
			<font>초과근무 구분 </font><input id="selectOverwork"	class="ui-button ui-widget ui-corner-all" value="초과근무" readonly>    <!-- 고정시켜둠 -->
				<input type="hidden" id="selectOverworkCode" name="overworkCode"  value="ASC008">  <!-- 초과근무코드 ASC008 -->
			<hr>
			<table>
				<tr>
					<td><font>신청자 </font></td>
		...
		<hr>
		<div id="overworkList_grid" style="height: 230px; width:1000px" class="ag-theme-balham"></div>
