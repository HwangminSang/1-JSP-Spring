...
<script>
	...
	function convertTimePicker() {  //신청시 시간형태를 바꿔서 넣는다,
				...
				.ajax({
					...
					success : function(data) {
						...
						for ( var index in travelList) {
							console.log("시작시간 : "+travelList[index].startTime);
...
<body>
	...
	<div class="container">
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<a class="nav-item nav-link active" data-toggle="tab" href="#breakAttd_tab" role="tab" aria-controls="nav-home" aria-selected="true"> 출장/교육 신청</a> 
				<a class="nav-item nav-link" data-toggle="tab" href="#breakSerach_tab" role="tab" aria-controls="nav-profile" aria-selected="false">출장/교육 조회</a>
			</div>
		</nav>
	</div>
	...
	<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
		<div class="tab-pane fade show active" id="breakAttd_tab" role="tabpanel" aria-labelledby="nav-home-tab">
			<font>출장/교육 구분 </font><input id="selectTravel" class="ui-button ui-widget ui-corner-all" readonly> <input type="hidden" id="selectTravelCode" name="travelCode">
			<hr>
		...
		<div class="tab-pane fade" id="breakSerach_tab" role="tabpanel"
			...
			<hr>
			<div id="travelList_grid" style="height: 230px; width: 800px"
